...
idf_file = r"C:\Users\eliem\OneDrive - Technion\BUA\LWR\pyenergyplus\sample_cube_buildings\IDFs\cube_1\openstudio\run\in.idf"
epw_file = r"C:\Users\eliem\AppData\Local\Building_urban_analysis\Libraries\EPW\IS_5280_A_Tel_Aviv.epw"  # Replace with your weather file path
output_dir = r"C:\Users\eliem\OneDrive - Technion\BUA\LWR\pyenergyplus\sample_cube_buildings\IDFs\cube_1\pyenergyplus"  # Replace with your output directory
...
def my_callback(state):
    ...
    surface_temp_handle = api.exchange.get_variable_handle(state, "SURFACE OUTSIDE FACE TEMPERATURE", surface_name)
...
api.exchange.request_variable(state, "SSURFACE OUTSIDE FACE TEMPERATURE", surface_name)
